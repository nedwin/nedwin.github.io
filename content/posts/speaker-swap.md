+++
title = "Inject the AI straight into my veins."
slug = "speaker-swap"
...
[^jon]: Jon writes a lot about working this way at [jonathannen.com](https://jonathannen.com).

[^oneshot]: Jon makes the case for one-shotting in [No agents, no plan](https://jonathannen.com/no-agents-no-plan/), and for deliberately spinning up lots of concurrent Claude sessions and contexts in [Straight to Claude](https://jonathannen.com/straight-to-claude/).

[^merry-go-round]: The swaps haven't all been 1:1. We've had some where speakers came back multiple times, or where they didn't need or want our intel beyond their in-house sessions, so instead we sent our crew to new folks. It's more of a karmic swap than a literal one-to-one mapping.
